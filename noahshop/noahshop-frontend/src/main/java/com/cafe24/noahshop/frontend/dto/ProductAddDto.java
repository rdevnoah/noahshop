...
public class ProductAddDto {
    ...
    public ProductAddDto(String no, String name, int price, String description, List<ProductImageVo> image, String dpMain, String isSell, Long categoryNo, Integer noOptionStock, List<OptionStockVo> optionStockVoList, MultipartFile multipartFile) {
        this.no = no;
        this.name = name;
        this.price = price;
